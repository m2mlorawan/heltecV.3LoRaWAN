...
freqList = [923.0,923.2,923.4]
defaultFreqList = [923.0, 923.2,923.4]
...
class LoRaWANHandler:
    ...
    # OTAA
    #DevEUI = [0x16, 0x86, 0xc4, 0x97, 0x72, 0x9d, 0xc5, 0xda] #[0x16, 0x86, 0xc4, 0x97, 0x72, 0x9d, 0xc5, 0xda]    # MSB
    #JoinEUI = [0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01]    #[0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01]    # MSB
    #AppKey = [0x59, 0xf4, 0x5c, 0xd8, 0xb3, 0x65, 0x53, 0x4b, 0x4d, 0x51, 0x03, 0xe0, 0x0f, 0x83, 0x69, 0x6a] #[0x59, 0xf4, 0x5c, 0xd8, 0xb3, 0x65, 0x53, 0x4b, 0x4d, 0x51, 0x03, 0xe0, 0x0f, 0x83, 0x69, 0x6a]    # MSB
...
#            print("RXcb receive: ", utime.ticks_ms())
    ...
    def __init__(self, configuration):
        ...
        #self.SXRadio = SX1262(spi_bus=1, clk=9, mosi=10, miso=11, cs=8, irq=14, rst=12, gpio=13)
        self.SXRadio = SX1262(spi_bus=1, clk=9, mosi=10, miso=11, cs=CS, irq=DIO1, rst=RESET, gpio=BUSY)
        ...
        self.SXRadio.begin(freq=freqList[currentFreq], bw=DRList[currentDR][0], sf=DRList[currentDR][1], cr=5, syncWord=SX126X_SYNC_WORD_PUBLIC, # syncWord=0x12 (private) 0x34 (public)
        ...
        #self.SXRadio.begin(freq=923, bw=125.0, sf=12, cr=8, syncWord=0x12,
